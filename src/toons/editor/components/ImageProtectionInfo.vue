...
<template>
  <div class="editor-page">
    <EditorBar title="Image protection" />
    <div class="editor-page-body">
      <div class="editor-form editor-protection-doc">
        <section>
        ...
        <section>
          ...
          <p>
            ...
            <code>assets.twentyseven.pictures</code> — separate from the pages people actually read. That address has
            one rule for every major AI crawler (OpenAI's GPTBot, Google's training crawler, Apple's, Common Crawl,
        ...
        <section>
          ...
          <p>
            ...
            "citation" AI crawlers — the ones that answer a question and link back to us, like ChatGPT's search feature
            or Perplexity. That's deliberate: we want the site found and referenced. Blocking everything would also hide
            us from that traffic. Only the raw image bytes get the hard "no."
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            storage until a person opens the studio and looks at them — the platform itself never sends stored images
            off to be trained on.
          </p>
          <p>
            The only time an image leaves storage toward an AI provider is when <strong>you</strong> choose to generate
            a new plate and deliberately attach a reference — a character sheet, or the previous page, so the art stays
            consistent. That's a one-off request you started: the reference goes out for that single generation only,
            the same way pasting a photo into an AI chat to ask "draw this next" would.
          </p>
        </section>
